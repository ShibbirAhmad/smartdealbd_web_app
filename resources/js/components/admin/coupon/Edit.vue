...
export default {
  ...
  methods: {
       ...
       getCouponItem(){
        axios.get('/api/get/edit/coupon/'+this.$route.params.id)
        .then(resp=>{
            console.log(resp);
                this.form.code=resp.data.coupon.code ;
                this.form.start_date=resp.data.coupon.start_date ;
                this.form.expire_date=resp.data.coupon.expire_date;
                this.form.discount_type=resp.data.coupon.discount_type ;
                this.form.discount_amount=resp.data.coupon.discount_amount ;
                this.loading = false;
          })
   },
    updateCupon() {
      this.form
        .post("/api/coupon/code/update/"+this.$route.params.id, {
          transformRequest: [
