  ...
  <div>
    ...
    <div class="content-wrapper">
      <section class="content-header">
        <h1>
          <router-link :to="{ name: 'supplier' }" class="btn btn-primary"
...
export default {
  ...
  methods: {
    getSupplier() {
      axios
        .get("/edit/supplier/" + this.$route.params.id)
        .then((resp) => {
          console.log(resp);
          if (resp.data.status == "SUCCESS") {
            ...
            this.form.company_name = resp.data.supplier.company_name;
            this.loading = false;
          } else {
    ...
    update() {
      this.form
        .post("/update/supplier/" + this.$route.params.id, {
          transformRequest: [
