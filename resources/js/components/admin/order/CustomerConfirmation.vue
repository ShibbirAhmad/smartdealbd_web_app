          ...
          <div class="row">
            <div class="col-lg-12 col-sm-12 col-xs-12 col-md-12">
             ...
             <div class="box-header with-border ">
                     ...
                     <h3 class="box-title orders-heading">Customer Confirmation Pending </h3>
                  ...
                  <table class="table table-bordered table-striped table-hover">
                    ...
                    <tbody>
                      ...
                      >
                        ...
                        <td> <button @click="orderReceived(order.id)" class="btn btn-sm btn-success">Received</button>   </td>
  ...
  methods: {
   ...
   dateFormatter(created_time){
    ...
    orderReceived(order_id) {
      ...
      //start progress bar
      this.$Progress.start();
      axios.get("/api/confimation/order/" + order_id)
        .then((resp) => {
