                      ...
                      >
                       ...
                       <td class="three-percent">
                        ...
                        <td>
                          ...
                          <router-link style="width:70px" class="btn btn-sm btn-warning" :to="{name:'orderEdit',params:{id:order.id}}">Edit</router-link>
                        </td>

                        <td>
                          <a href="#" @click="comment(order.id, index,order.comment)">Comment</a>
                        </td>
                      </tr>
                    </tbody>
                  </table>
