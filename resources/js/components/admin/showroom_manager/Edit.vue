          ...
          <div class="col-lg-8 col-md-8 col-lg-offset-2">
            <div class="box box-primary">
              <div class="box-header with-border text-center">
                <h3 class="box-title">Edit Showroom Manager</h3>
              </div>
              <div class="box-body">
                <form
...
export default {
  ...
  methods: {
    getManager() {
      axios
        .get("/api/showroom/manager/edit/item/" + this.$route.params.id)
        .then((resp) => {
          console.log(resp);
          this.form.showroom_id = resp.data.manager.showroom_id;
    ...
    updateManager() {
      this.form
        .post("/api/showroom/manager/update/"+this.$route.params.id, {
          transformRequest: [
