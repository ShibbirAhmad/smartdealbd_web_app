                        ...
                        <div class="col-lg-8 col-lg-offset-1">
                            <div class="box box-primary">
                                <div class="box-header with-border">
                                    <div class="row">
                                        <div class="col-md-6"><h3 class="box-title">City table</h3></div>
                                        <div class="col-md-6">
                                            <input type="text" class="form-control" v-model="search_data" placeholder="search here" @keyup="searchCity">
                                        </div>
                                    </div>
        ...
        methods: {
            ...
            searchCity(){
                if (this.search_data.length >= 3 ) {
                   axios.get('/api/search/city/'+this.search_data)
                   .then(resp => {
                       this.cities=resp.data.cities ;
