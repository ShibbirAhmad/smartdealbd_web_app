  ...
  methods: {
    ...
    loadMoreData: function loadMoreData(e) {
      ...
      axios.get("/api/load/more/dashboard/data").then(function (resp) {
        ...
        _this.today_shipped_orders = resp.data.today_shipped_orders;
        _this.today_shipped_orders_products = resp.data.today_shipped_orders_products;
        _this.today_confirmed_orders = resp.data.today_confirmed_orders;
        _this.today_confirmed_orders_products = resp.data.today_confirmed_orders_products;
                                ...
                                [
                                  ...
                                  _vm.admin_order_yesterday
                                    ? _c(
                                        "tbody",
                                        _vm._l(
                                          _vm.admin_orders.yesterday_create,
                                          function(order_create_count, index) {
                                            return _c("tr", { key: index }, [
                                              _c("td", [
                                                _vm._v(_vm._s(index + 1))
                                  ...
                                  _vm.admin_order_this_week
                                    ? _c(
                                        "tbody",
                                        _vm._l(
                                          _vm.admin_orders.this_week_create,
                                          function(order_create_count, index) {
                                            return _c("tr", { key: index }, [
                                              _c("td", [
                                                _vm._v(_vm._s(index + 1))
                                  ...
                                  _vm.admin_order_this_month
                                    ? _c(
                                        "tbody",
                                        _vm._l(
                                          _vm.admin_orders.this_month_create,
                                          function(order_create_count, index) {
                                            return _c("tr", { key: index }, [
                                              _c("td", [
                                                _vm._v(_vm._s(index + 1))
                    ...
                    _vm.$can("view dashboard")
                      ? _c("div", { staticClass: "row" }, [
                          _c(
                            ...
                            [
                              _vm._v(" Today Confirmed Order  "),
                              _c("b", [
                                _vm._v(
                                  " " + _vm._s(_vm.today_confirmed_orders) + " "
                                )
                              ])
                            ]
                          ),
                          ...
                          _c("div", { staticClass: "col-lg-12" }, [
                            _c("div", { staticClass: "box box-primary" }, [
                              ...
                              _c(
                                ...
                                { staticClass: "box-body" },
                                [
                                  _vm.today_confirmed_orders_products.length
                                    ? _c(
                                        "carousel",
                                        {
                                          attrs: {
                                        ...
                                        _vm._l(
                                          _vm.today_confirmed_orders_products,
                                          function(item) {
                                            return _c(
                                              "div",
                                              {
                    ...
                    _vm.$can("view dashboard")
                      ? _c("div", { staticClass: "row" }, [
                          _c(
                            ...
                            [
                              _vm._v(" Today Shipped Order  "),
                              _c("b", [
                                _vm._v(
                                  " " + _vm._s(_vm.today_shipped_orders) + " "
                                )
                              ])
                            ]
                          ),
                          ...
                          _c("div", { staticClass: "col-lg-12" }, [
                            _c("div", { staticClass: "box box-primary" }, [
                              ...
                              _c(
                                ...
                                { staticClass: "box-body" },
                                [
                                  _vm.today_shipped_orders_products.length
                                    ? _c(
                                        "carousel",
                                        {
                                          attrs: {
                                        ...
                                        _vm._l(
                                          _vm.today_shipped_orders_products,
                                          function(item) {
                                            return _c(
                                              "div",
                                              {
