    ...
    orderNoteList: function orderNoteList() {
      ...
      axios.get('/api/get/order/note/list/' + this.order_id).then(function (resp) {
        if (resp.data.status == 'OK') {
          _this.order_note_list = resp.data.notes;
        }
      });
    },
      ...
      axios.get("/orders?page=" + page, {
        ...
        if (resp.data.status == "SUCCESS") {
          ...
          _this3.$Progress.finish();
            ...
            _this3.$toasted.show("someting went to wrong", {
              type: "error",
              position: "top-center",
              duration: 5000
            });
    ...
    others: function others() {
      ...
      axios.get("/others").then(function (resp) {
        ...
        if (resp.data.status == "SUCCESS") {
          ...
          _this4.comments = resp.data.comments;
        }
      });
    },
    ...
    approved: function approved(order, index) {
      ...
      axios.get("/approved/order/" + order.id).then(function (resp) {
        ...
        if (resp.data.status == "SUCCESS") {
          ...
          _this5.orders.data[index].status = 3;
        } //not resp success.....
        else {
            _this5.$toasted.show("someting went to wrong", {
              type: "error",
              position: "top-center",
              duration: 2000
            });
    ...
    returnOrder: function returnOrder(order, index) {
      ...
      axios.get("/return/order/" + order.id).then(function (resp) {
        ...
        if (resp.data.status == "SUCCESS") {
          ...
          _this7.orders.data[index].status = 7;
      ...
      axios.get("/pending/order/" + order.id).then(function (resp) {
        ...
        if (resp.data.status == "SUCCESS") {
          ...
          _this9.orders.data[index].status = 2;
            ...
            _this9.$toasted.show("someting went to wrong", {
              type: "error",
              position: "top-center",
              duration: 2000
            });
            ...
            if (other.value) {
              axios.get("/api/order/comment", {
                ...
                if (resp.data.status == "OK") {
                  ...
                  _this16.$toasted.show(resp.data.message, {
                    type: "success",
                    duration: 4000,
                    position: "top-center"
                  });
